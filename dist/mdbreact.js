...
var Alert = function Alert(props) {
  ...
  if (dismiss) {
    alertComponent = React__default.createElement(
...
var Box = function Box(props) {
  ...
  var classes = classNames(
    display && 'd-'.concat(display),
    justifyContent && 'justify-content-'.concat(justifyContent),
    flex && 'flex-'.concat(flex),
    alignItems && 'align-items-'.concat(alignItems),
    alignContent && 'align-content-'.concat(alignContent),
    alignSelf && 'align-self-'.concat(alignSelf),
    color && ''.concat(color, '-text'),
    bgColor && 'bg-'.concat(bgColor),
    marginOrPadding(m, 'm'),
...
var Fa = function Fa(props) {
  ...
  var classes = classNames(
    iconPrefix,
    list ? 'fa-li' : false,
    icon ? 'fa-'.concat(icon) : false,
    size ? 'fa-'.concat(size) : false,
    fixed ? 'fa-fw' : false,
    pull ? 'fa-pull-'.concat(pull) : false,
    border ? 'fa-border' : false,
    spin ? 'fa-spin' : false,
    pulse ? 'fa-pulse' : false,
    rotate ? 'fa-rotate-'.concat(rotate) : false,
    flip ? 'fa-flip-'.concat(flip) : false,
    inverse ? 'fa-inverse' : false,
    stack ? 'fa-'.concat(stack) : false,
    className
  );
  return React__default.createElement(
    'i',
...
var Card = function Card(props) {
  ...
  var classes = classNames(
    ...
    _defineProperty(_classNames, ''.concat(text, '-text'), text),
    _defineProperty(_classNames, 'border-'.concat(border), border),
    _classNames),
    'card',
    color,
    className
...
var CardFooter = function CardFooter(props) {
  ...
  var classes = classNames(
    ...
    _defineProperty(_classNames, 'border-'.concat(border), border),
    _defineProperty(_classNames, 'bg-transparent', transparent),
    _defineProperty(_classNames, 'text-muted', muted),
    _defineProperty(_classNames, ''.concat(text, '-text'), text),
    _classNames),
    'card-footer',
    color,
...
var CardImage = function CardImage(props) {
  ...
  var Tag = tag;
  var innerContent = React__default.createElement(
    Tag,
    _extends(
      {
        ...
        value: function render() {
          ...
          var _loop = function _loop(i) {
            ...
            CarouselIndicatorsArray.push(
              React__default.createElement(CarouselIndicator, {
...
var Container = function Container(props) {
  ...
  var classes = classNames(
    fluid ? 'container-fluid' : size ? 'container-'.concat(size) : 'container',
    className
  );
  return React__default.createElement(
    Tag,
    ...
    rows &&
      rows.map(function(row, index) {
        return React__default.createElement(
          ...
          columns
            ? columns.map(function(_ref, key, array) {
...
var TableFoot = function TableFoot(props) {
  ...
  var classes = classNames(
    ...
    _defineProperty(_classNames, 'thead-'.concat(color), color && isTheadColor),
    _defineProperty(_classNames, ''.concat(color), color && !isTheadColor),
    _classNames)
  );
  return React__default.createElement(
    'thead',
...
var DataTableTable = function DataTableTable(props) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement(DataTableHead, {
        color: theadColor,
        ...
        },
        {
          ...
          value: function render() {
            ...
            var _this$props3 = this.props,
              ...
              attributes = _objectWithoutProperties(_this$props3, [
                'background',
                'children',
                'className',
                'containerClass',
            ...
            var classes = classNames(
              formControlClass,
              size ? 'form-control-'.concat(size) : false,
    ...
    _createClass(SelectInput, [
      ...
      },
      {
        ...
        value: function render() {
          ...
          var value = context.state.isEmpty
...
var DataTableEntries = function DataTableEntries(props) {
  ...
  return React__default.createElement(
    ...
    paging &&
      displayEntries &&
      React__default.createElement(DataTableSelect, {
        value: entries,
...
var DataTableSearch = function DataTableSearch(props) {
  ...
  return React__default.createElement(
    ...
    searching &&
      React__default.createElement(DataTableInput, {
        value: search,
  ...
  return React__default.createElement(
    ...
    info &&
      React__default.createElement(
        ...
        !NO_RECORDS
          ? ''
              .concat(SHOWING_LABEL, ' ')
              .concat(RECORDS, ' ')
              .concat(TO_LABEL, ' ')
              .concat(RECORDS_ON_PAGE, ' ')
              .concat(OF_LABEL, ' ')
              .concat(ENTRIES, ' ')
              .concat(ENTRIES_LABEL)
          : ''.concat(SHOWING_LABEL, ' 0 ').concat(ENTRIES_LABEL)
      )
  );
};
...
var Pagination = function Pagination(props) {
  ...
  var classes = classNames(
    ...
    _defineProperty(_classNames, 'pg-'.concat(color), color),
    _defineProperty(_classNames, 'pagination-'.concat(size), size),
    _classNames),
    'pagination',
    className
  );
              ...
              React__default.createElement(
                ...
                React__default.createElement(
                  ...
                  React__default.createElement(
                    ...
                    React__default.createElement('span', null, label[0])
                  )
                ),
                this.choosePagesGroup().map(function(page) {
                  return React__default.createElement(
                    PageItem,
                    {
      ...
      },
      {
        ...
        value: function render() {
          var _this$props4 = this.props,
            ...
            attributes = _objectWithoutProperties(_this$props4, [
              'autoWidth',
              'barReverse',
              'bordered',
              'borderless',
            ...
            (filter || exportToCSV) &&
              React__default.createElement(
                ...
                React__default.createElement(
                  ...
                  filter &&
                    React__default.createElement(mdbreact.MDBSelect, {
      ...
      },
      {
        ...
        value: function render() {
          ...
          var classes = classNames(
            ...
            _defineProperty(_classNames, 'btn-group-'.concat(size), !!size),
            _defineProperty(_classNames, 'dropdown', !group),
            _defineProperty(_classNames, 'show', isOpen),
            _defineProperty(_classNames, 'dropup', dropup),
            _defineProperty(_classNames, 'dropright', dropright),
            _defineProperty(_classNames, 'dropleft', dropleft),
            _classNames),
            className
          );
          return React__default.createElement(
    ...
    _createClass(DropdownMenu, [
      {
        ...
        value: function render() {
          ...
          var classes = classNames(
            ...
            _defineProperty(_classNames, 'dropdown-'.concat(color), color),
            _defineProperty(_classNames, 'show', isOpen),
            _defineProperty(_classNames, 'basic', basic),
            _classNames),
            'dropdown-menu',
            className
          );
    ...
    _createClass(Iframe, [
      {
        ...
        value: function render() {
          ...
          var wrapperClasses = classNames(
            ...
            ratio ? 'embed-responsive-'.concat(ratio) : 'embed-responsive-16by9'
          );
...
var ListGroupItem = function ListGroupItem(props) {
  ...
  var classes = classNames(
    ...
    _defineProperty(_classNames, 'list-group-item-'.concat(color), ' color'),
    _defineProperty(_classNames, 'list-group-item-action', hover),
    _classNames)
  );
...
var Nav = function Nav(props) {
  ...
  var classes = classNames(
    ...
    pills && color ? 'pills-'.concat(color) : false,
    (tabs || classicTabs) && color ? 'tabs-'.concat(color) : false,
    className
  );
  return React__default.createElement(
    Tag,
        ...
        value: function render() {
          ...
          return React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement('small', null, text),
              React__default.createElement(MDBCloseIcon, {
...
var Rating = function Rating(props) {
  ...
  var Tag = props.tag,
    ...
    commonAttributes = _objectWithoutProperties(props, [
      'tag',
      'containerClassName',
      'iconClassName',
      'iconFaces',
  ...
  if (data.length) {
    renderedIcons = data.map(function(_ref, index) {
      ...
      if (isFormActive) {
        tooltipContent = React__default.createElement(
          'form',
          {
...
var Treeview = function Treeview(props) {
  ...
  var ulClasses = classNames(
    ...
    theme && 'treeview-'.concat(theme, '-list'),
...
var TreeviewList = function TreeviewList(props) {
  ...
  var folder = classNames(
    theme && 'closed treeview-'.concat(theme, '-element d-block'),
    !children && 'ml-2',
    opened && 'opened',
    disabled && disabledClassName
  );
    ...
    _createClass(Typography, [
      {
        ...
        value: function render() {
          ...
          var classes = classNames(
            variant && variant,
            colorText && ''.concat(colorText.toLowerCase(), '-text'),
          ...
          if (note) {
            return React__default.createElement(
              ...
              React__default.createElement('strong', null, noteTitle),
              children
            );
          }
      ...
      _defineProperty(_assertThisInitialized(_this), 'keyDownHandler', function(
        ...
        if (_this.suggestionsList && _this.state.filteredSuggestions) {
          ...
          suggestionsListNodes.length >= 5 &&
            suggestionsListNodes[_this.state.focusedListItem].scrollIntoView({
              block: 'center',
              behavior: 'smooth'
            });
  ...
  (function(_Component) {
    ...
    function DatePicker() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'state', {
        ...
        muiTheme: core.createMuiTheme(
          _objectSpread2({}, _this.props.theme, {
            typography: {
        ...
        value: function render() {
          ...
          return React__default.createElement(
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                materialUiPickers.MuiPickersUtilsProvider,
                {
                  locale: locale,
                  moment: moment,
                  utils: MomentUtils
...
var InputFile = function InputFile(_ref) {
  ...
  return React__default.createElement(
    ...
    React__default.createElement(
      ...
      React__default.createElement('span', null, btnTitle),
      React__default.createElement('input', {
        multiple: multiple,
        onChange: onChangeHandler,
        type: 'file'
  ...
  (function(_React$Component) {
    ...
    function Lightbox() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'scrollZoom', function(e) {
        ...
        if (
          _this.slideRefs[activeKey] === imgSrc &&
          sliderOpened &&
          ...
          var trans3d = _this.slideRefs[activeKey].style.transform
            .split(') ')
            .filter(function(el) {
        ...
        if (!changeSlide) {
          ...
          var trans3d_Unset = function trans3d_Unset(index) {
            return '\n        translate(-50%, -50%)\n        translate3d(0px, 0px, 0px)\n        scale('.concat(
              galleryImagesData[index].zoomedScale,
              ')\n      '
            );
          };
        ...
        if (dragImg && !resize) {
          ...
          if (Math.abs(diffX) > Math.abs(diffY)) {
            ...
            var styleSlide = function styleSlide(index) {
              return 'transform:\n          translate(-50%,-50%)\n          translate3d('
                .concat(diffX, 'px, 0, 0)\n          scale(')
                .concat(galleryImagesData[index].zoomedScale, ')\n        ');
            };
      ...
      },
      {
        ...
        value: function render() {
          var _this$props5 = this.props,
            ...
            attributes = _objectWithoutProperties(_this$props5, [
              'bg',
              'breakWidth',
              'children',
              'className',
          ...
          var sidenav = React__default.createElement(
            Tag,
            _extends({}, attributes, {
              ref: this.sideNavRef,
              className: classes,
...
var SmoothScroll = function SmoothScroll(props) {
  ...
  var classes = classNames(
    ...
    rounded ? 'btn-rounded' : false,
    block ? 'btn-block' : false,
    social ? 'btn-'.concat(social) : false,
    'Ripple-parent',
    className
  );
  var fixedStyles = {
...
var Spinner = function Spinner(props) {
  var theChosenColorSpinner = function theChosenColorSpinner(spinnerClasses) {
    if (props.multicolor) {
      var _theSpinnerItself = React__default.createElement(
        'div',
        null,
        React__default.createElement(
          'div',
    ...
    var theSpinnerItself = React__default.createElement(
      'div',
      {
...
var Step = function Step(props) {
  ...
  if (form) {
    step = React__default.createElement(
      Tag,
      {
        className: stepClass
      },
...
var Stepper = function Stepper(props) {
  ...
  if (form || icon) {
    stepper = React__default.createElement(
      'div',
      {
    ...
    _createClass(Sticky, [
      ...
      },
      {
        ...
        value: function render() {
          ...
          var element = React__default.cloneElement(
            children({
              isSticky: isSticky,
              wasSticky: wasSticky,
              distanceFromTop: distanceFromTop,
            ...
            React__default.createElement(
              ...
              React__default.createElement(
                ...
                React__default.createElement(
                  ...
                  React__default.createElement('th', null, 'Sort '),
                  React__default.createElement('th', null, 'Delete ')
                )
              ),
              React__default.createElement(
                'tbody',
                null,
                initialData.map(function(tr, trIndex) {
                  return React__default.createElement(
                    'tr',
                    {
                      key: trIndex
    ...
    function TimePickerClock() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'isValueAllowed', function(
        ...
        return allowedValues.length
          ? allowedValues.find(function(item) {
              return item === value;
            })
          : value >= min && value <= max;
      });
                    ...
                    React__default.createElement(
                      ...
                      React__default.createElement(
                        ...
                        React__default.createElement(
                          ...
                          hoursFormat === 12 &&
                            React__default.createElement(TimePickerAmPmBlock, {
                              color: color,
                              dayTime: initialDayTime,
          ...
          return React__default.createElement(
            ...
            counter &&
              ...
              React__default.createElement(
                ...
                character,
                typeCounter && '/'.concat(characterMax)
              ),
            children
          );
        }
