...
var Button = function Button(props) {
  ...
  return React__default.createElement(Tag, _extends({
    ...
    download: download,
    disabled: disabled
  }), props.children, disabled ? false : React__default.createElement(Waves, {
    cursorPos: cursorPos,
    outline: outline,
    flat: flat
  }));
      ...
      var renderFunction = function renderFunction() {
        return React__default.createElement(React__default.Fragment, null, icon && React__default.createElement(Fa, {
          ...
          onClick: function onClick(e) {
            onIconClick ? onIconClick(e) : _this2.setFocus(e);
          },
...
var TreeviewItem = function TreeviewItem(props) {
  ...
  var fab = props.fab,
      ...
      Tag = props.tag,
      title = props.title,
      attributes = _objectWithoutProperties(props, ["fab", "fal", "far", "icon", "tag", "title"]);
  ...
  var classes = classNames(theme && "treeview-".concat(theme, "-items treeview-").concat(theme, "-element closed mb-1"), active === target && !active.classList.contains("opened") ? "opened" : "");
  return React__default.createElement(Tag, _extends({}, attributes, {
    className: classes,
    ref: targetRef,
    onClick: handleClick,
  ...
  }), React__default.createElement(mdbreact.MDBIcon, {
    className: "mr-2",
    fab: fab,
    fal: fal,
    far: far,
...
var TreeviewList = function TreeviewList(props) {
  ...
  var children = props.children,
      ...
      Tag = props.tag,
      title = props.title,
      attributes = _objectWithoutProperties(props, ["children", "fab", "fal", "far", "icon", "tag", "title"]);

  var _useContext = React.useContext(TreeviewContext),
      theme = _useContext.theme;

  var nestedClasses = classNames("nested", open && "active");
  var folder = classNames(theme && "closed treeview-".concat(theme, "-element d-block"), open && "opened");
  var classes = classNames(theme && "treeview-".concat(theme, "-items px-0"));
  ...
  var collapse = theme && React__default.createElement(mdbreact.MDBCollapse, {
    isOpen: open
  }, child);
  var iconArrow = theme !== "colorful" ? "angle-right" : open ? "minus-circle" : "plus-circle";
  var arrow = React__default.createElement(mdbreact.MDBIcon, {
    icon: iconArrow,
    rotate: theme !== "colorful" ? open ? "90 down" : "0" : "",
    className: "rotate"
  });
  var btn = children && React__default.createElement(mdbreact.MDBBtn, {
    flat: true,
  ...
  return React__default.createElement(Tag, _extends({}, attributes, {
    ...
    className: folder,
    onClick: function onClick(e) {
      return theme && handleSwitch(e);
    }
  }, theme ? arrow : btn, React__default.createElement("span", null, React__default.createElement(mdbreact.MDBIcon, {
    className: iconClasses,
    fab: fab,
    fal: fal,
    far: far,
