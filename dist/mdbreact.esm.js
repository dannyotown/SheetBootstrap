...
function (_Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      return react.createElement(react_3, null, backdrop && react.createElement(Transition, {
        timeout: timeout,
        in: this.state.isOpen,
...
var Link$1 = function (_React$Component) {
  _inherits$4(Link$$1, _React$Component);

  function Link$$1() {
    var _temp, _this, _ret;

    _classCallCheck$4(this, Link$$1);
  ...
  Link$$1.prototype.render = function render() {
    var _props = this.props,
