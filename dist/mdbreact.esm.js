...
function (_Component) {
  ...
  _createClass(Col, [{
    ...
    value: function render() {
      ...
      var classes = classNames(size && "col-" + size, xs && "col-" + xs, sm && "col-sm-" + sm, md && "col-md-" + md, lg && "col-lg-" + lg, xl && "col-xl-" + xl, !size && !xs && !sm && !md && !lg && !xl ? "col" : "", top && "align-self-start", middle && "align-self-center", bottom && "align-self-end", className);
      return React.createElement(Tag, _extends({}, attributes, {
        className: classes
      }));
    }
...
var DataTableHead = function DataTableHead(props) {
  var color = props.color,
      ...
      attributes = _objectWithoutProperties(props, ["color", "columns", "handleSort", "scrollX", "scrollY", "sortable", "textWhite"]);

  var theadClasses = classNames(color !== "dark" && color !== "light" ? color : "thead-".concat(color), {
  ...
  return React.createElement(Fragment, null, (scrollY || scrollX) && React.createElement("colgroup", null, columns.map(function (col) {
  ...
  })), React.createElement("thead", _extends({}, attributes, {
    ...
    }, col.label, sortable && React.createElement(Fa, {
      icon: "sort",
...
var DataTablePagination = function DataTablePagination(props) {
  ...
  return React.createElement("div", {
  ...
  }, React.createElement("span", null, label[0]))), pages.map(function (page, index) {
    return React.createElement(PageItem, {
      ...
      className: "page-link",
      onClick: function onClick() {
        return changeActivePage(index);
      }
    }, index + 1, " ", index === activePage && React.createElement("span", {
      className: "sr-only"
    }, "(current)")));
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          attributes = _objectWithoutProperties(_this$props, ["autoWidth", "bordered", "borderless", "btn", "children", "dark", "data", "entriesLabel", "exportToCSV", "fixed", "hover", "info", "infoLabel", "maxHeight", "order", "paging", "paginationLabel", "responsive", "responsiveSm", "responsiveMd", "responsiveLg", "responsiveXl", "searching", "searchLabel", "scrollX", "scrollY", "small", "sortable", "striped", "tbodyColor", "tbodyTextWhite", "theadColor", "theadTextWhite"]);
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          gap = _this$props.gap,
          attributes = _objectWithoutProperties(_this$props, ["children", "containerClass", "size", "group", "getValue", "className", "type", "el", "tag", "id", "hint", "validate", "value", "label", "error", "success", "disabled", "labelClass", "icon", "iconBrand", "iconClass", "iconLight", "iconRegular", "iconSize", "filled", "gap"]);
      ...
      var iconClassFix = classNames(isNotEmpty ? "active" : false, iconClass, "prefix");
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return React.createElement(TextField, _extends({}, this.props, {
        ref: function ref(el) {
          if (el) _this.controlEl = el.inputElRef.inputElRef;
        }
      }));
    }
  }]);
    ...
    value: function render() {
      ...
      return React.createElement(NumericInput, _extends({}, attributes, {
        onChange: function onChange(event) {
          return _this2.onChangeHandler(event);
        },
        className: classes
      }));
    }
