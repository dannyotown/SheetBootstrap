...
import { MDBIcon, MDBCollapse, MDBBtn } from 'mdbreact';
...
var TreeviewList = function TreeviewList(props) {
  ...
  var collapse = theme && React.createElement(MDBCollapse, {
    isOpen: open
  }, child);
  var iconArrow = theme !== "colorful" ? "angle-right" : open ? "minus-circle" : "plus-circle";
  var arrow = React.createElement(MDBIcon, {
    icon: iconArrow,
    rotate: theme !== "colorful" ? open ? "90 down" : "0" : "",
    className: "rotate"
  });
  var btn = children && React.createElement(MDBBtn, {
    flat: true,
  ...
  }, theme ? arrow : btn, React.createElement("span", null, React.createElement(MDBIcon, {
    className: iconClasses,
    fab: fab,
    fal: fal,
    far: far,
