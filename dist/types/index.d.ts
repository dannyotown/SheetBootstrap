import { FunctionComponent, ReactNode, Component, ElementType, RefObject, SyntheticEvent, FormEvent } from 'react';
...
declare const MDBFooter$1: FunctionComponent<{
  color?: string;
  children?: ReactNode;
  className?: string;
  tag?: string;
