              ...
              <div className="mdb-feed">
                  ...
                  <div className="excerpt">
                    ...
                    <div className="feed-footer">
                      <div className="d-flex">
                        <a className="comment" aria-expanded="false" aria-controls="collapseExample-1" onClick={this.toggleCollapse('collapseExample-1')}>Comment </a> &middot; <span><a> 7 </a></span>
                        <a className="thumbs">
                      ...
                      <Collapse id="collapseExample-1" isOpen={this.state.collapseID}>
                ...
                <div className="news">
                  ...
                  <div className="excerpt">
                    ...
                    <div className="feed-footer">
                      <div className="d-flex">
                        <a className="comment" aria-expanded="false" aria-controls="collapseExample-2" onClick={this.toggleCollapse('collapseExample-2')}>Comment </a> &middot; <span><a> 31 </a></span>
                        <a className="thumbs">
                          <Tooltip tag="span" placement="top" tooltipContent="I like it">
                            <Fa icon="thumbs-up" />
                          </Tooltip>
                      ...
                      <Collapse id="collapseExample-2" isOpen={this.state.collapseID}>
                        <Card className="card-body mt-1">
                          <Input type="textarea" label="Add comment" />
                          <div className="d-flex justify-content-end">
                ...
                <div className="news">
                  ...
                  <div className="excerpt">
                    ...
                    <div className="feed-footer">
                      <div className="d-flex">
                        <a className="comment" aria-expanded="false" aria-controls="collapseExample-3" onClick={this.toggleCollapse('collapseExample-3')}>Comment </a> &middot; <span><a> 12 </a></span>
                        <a className="thumbs">
                          <Tooltip tag="span" placement="top" tooltipContent="I like it">
                            <Fa icon="thumbs-up" />
                          </Tooltip>
                      ...
                      <Collapse id="collapseExample-3" isOpen={this.state.collapseID}>
                        <Card className="card-body mt-1">
                          <Input type="textarea" label="Add comment" />
                          <div className="d-flex justify-content-end">
                ...
                <div className="news">
                  ...
                  <div className="excerpt">
                    ...
                    <div className="feed-footer">
                      <div className="d-flex">
                        <a className="comment" aria-expanded="false" aria-controls="collapseExample-4" onClick={this.toggleCollapse('collapseExample-4')}>Comment </a> &middot; <span><a> 25 </a></span>
                        <a className="thumbs">
                          <Tooltip tag="span" placement="top" tooltipContent="I like it">
                            <Fa icon="thumbs-up" />
                          </Tooltip>
                      ...
                      <Collapse id="collapseExample-4" isOpen={this.state.collapseID}>
                        <Card className="card-body mt-1">
                          <Input type="textarea" label="Add comment" />
                          <div className="d-flex justify-content-end">
                ...
                <div className="news">
                  ...
                  <div className="excerpt">
                    ...
                    <div className="feed-footer">
                      <div className="d-flex">
                        <a className="comment" aria-expanded="false" aria-controls="collapseExample-5" onClick={this.toggleCollapse('collapseExample-5')}>Comment </a> &middot; <span><a> 47 </a></span>
                        <a className="thumbs">
                          <Tooltip tag="span" placement="top" tooltipContent="I like it">
                            <Fa icon="thumbs-up" />
                          </Tooltip>
                      ...
                      <Collapse id="collapseExample-5" isOpen={this.state.collapseID}>
                        <Card className="card-body mt-1">
                          <Input type="textarea" label="Add comment" />
                          <div className="d-flex justify-content-end">
