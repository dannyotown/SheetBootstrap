              ...
              <Card pricing>
                ...
                <CardBody className="striped mb-1">
                  <ul>
                    <li>
                      <p className="mt-2">
                        <Fa icon="check" className="green-text pr-2" />
                        20 GB Of Storage
                      </p>
                    </li>
                    <li>
                      <p>
                        <Fa icon="check" className="green-text pr-2" />2 Email
                        Accounts
                      </p>
                    </li>
                    <li>
                      <p>
                        <Fa icon="times" className="red-text pr-2" />
                        24h Tech Support
                      </p>
                    </li>
                    <li>
              ...
              <Card pricing>
                ...
                <CardBody className="striped mb-1">
                  <ul>
                    ...
                    <li>
                      <p>
                        <Fa icon="check" className="green-text pr-2" />4 Email
                        Accounts
                      </p>
                    </li>
                    <li>
              ...
              <Card pricing>
                ...
                <CardBody className="striped mb-1">
                  <ul>
                    ...
                    <li>
                      <p>
                        <Fa icon="check" className="green-text pr-2" />5 Email
                        Accounts
                      </p>
                    </li>
                    <li>
                ...
                <CardBody>
                  ...
                  <div className="d-flex justify-content-center">
                    <div className="card-circle d-flex justify-content-center align-items-center">
                      <Fa icon="home" className="light-blue-text" />
                    </div>
                  </div>
                  ...
                  <Button rounded color="light-blue">
                    Buy now
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card className="purple-gradient">
                <CardBody className="white-text">
                  ...
                  <div className="d-flex justify-content-center">
                    <div className="card-circle d-flex justify-content-center align-items-center">
                      <Fa icon="group" className="light-blue-text" />
                    </div>
                  </div>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex justify-content-center">
                    <div className="card-circle d-flex justify-content-center align-items-center">
                      <Fa icon="bar-chart" className="light-blue-text" />
                    </div>
                  </div>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex justify-content-center">
                    <div className="card-circle d-flex justify-content-center align-items-center">
                      <Fa icon="home" className="indigo-text" />
                    </div>
                  </div>
                  <h2 className="font-weight-bold my-4">59$</h2>
                  <p className="grey-text">
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card>
                <CardBody>
                  ...
                  <div className="d-flex justify-content-center">
                    <div className="card-circle d-flex justify-content-center align-items-center">
                      <Fa icon="bar-chart" className="indigo-text" />
                    </div>
                  </div>
                  <h2 className="font-weight-bold my-4">99$</h2>
                  <p className="grey-text">
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card pricing>
                <CardBody>
                  ...
                  <Button rounded color="danger" className="mb-4">
                    Buy now
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card pricing className="white-text">
                ...
                <CardBody className="striped green-striped card-background px-5">
                  ...
                  <Button rounded gradient="aqua" className="mb-3 mt-3">
                    Buy now
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card pricing className="white-text">
                ...
                <CardBody className="striped orange-striped card-background px-5">
                  ...
                  <Button rounded gradient="peach" className="mb-3 mt-3">
                    Buy now
                  </Button>
                </CardBody>
              </Card>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <Card pricing className="white-text">
                ...
                <CardBody className="striped purple-striped card-background px-5">
                  ...
                  <Button rounded gradient="purple" className="mb-3 mt-3">
                    Buy now
                  </Button>
                </CardBody>
              </Card>
