...
const BlogPage = () =>  {
  return(
    <Container>
      <DocsLink title="Blog Sections" href="https://mdbootstrap.com/react/sections/blog/" />
      <Card className="my-5 px-5 pb-5">
        <CardBody>
          ...
          <Row>
            ...
            <Col lg="5">
              <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
                <img className="img-fluid" src="https://mdbootstrap.com/img/Photos/Others/img%20(34).jpg" alt="" />
                <a><Mask overlay="white-slight"/></a>
              </View>
            </Col>
          </Row>
          ...
          <Row>
            <Col lg="5">
              <View className="rounded z-depth-2 mb-lg-0 mb-4" hover waves>
                <img className="img-fluid" src="https://mdbootstrap.com/img/Photos/Others/img (28).jpg" alt="" />
                <a><Mask overlay="white-slight"/></a>
              </View>
            </Col>
            <Col lg="7">
      ...
      <Card className="my-5 px-5 pb-5">
        <CardBody className="text-center">
          ...
          <Row>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <View hover className="rounded z-depth-2 mb-4" waves>
                <img className="img-fluid" src="https://mdbootstrap.com/img/Photos/Others/images/43.jpg" alt="" />
                <Mask overlay="white-slight"/>
              </View>
            ...
            <Col lg="4" md="12" className="mb-lg-0 mb-4">
              <View hover className="rounded z-depth-2 mb-4" waves>
                <img className="img-fluid" src="https://mdbootstrap.com/img/Photos/Others/images/13.jpg" alt="" />
                <Mask overlay="white-slight"/>
              </View>
            ...
            <Col md="12">
              <Card reverse>
                <View hover cascade waves>
                  <img src="https://mdbootstrap.com/img/Photos/Slides/img%20(142).jpg" alt="" className="img-fluid"/>
