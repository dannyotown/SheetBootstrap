                ...
                <Stepper form>
                  <Step form>
                    <a href="#formstep1" onClick={this.swapFormActive(1)(1)}>
                      <Button color={this.state.formActivePanel1 === 1 ? 'indigo' : 'default'} circle>1</Button></a>
                    <p>Step 1</p>
                  </Step>
                  <Step form>
                    <a href="#formstep2" onClick={this.swapFormActive(1)(2)}>
                      <Button color={this.state.formActivePanel1 === 2 ? 'indigo' : 'default'} circle>2</Button></a>
                    <p>Step 2</p>
                  </Step>
                  <Step form>
                    <a href="#formstep3" onClick={this.swapFormActive(1)(3)}>
                      <Button color={this.state.formActivePanel1 === 3 ? 'indigo' : 'default'} circle>3</Button></a>
                    <p>Step 3</p>
                  </Step>
                </Stepper>
...
{ this.state.formActivePanel1 === 3  &&
                    (<Col md="12">
                      ...
                      <Button color="default" rounded className="float-right" onClick={this.handleSubmission}>submit</Button>
                    </Col>)}
                  </Row>
                </form>
        ...
        <Card>
          <CardBody>
            ...
            <Stepper icon>
              <Step icon="folder-open-o" stepName="Basic Information" onClick={this.swapFormActive(2)(1)}></Step>
              <Step icon="pencil" stepName="Personal Data" onClick={this.swapFormActive(2)(2)}></Step>
              <Step icon="photo" stepName="Terms and Conditions" onClick={this.swapFormActive(2)(3)}></Step>
              <Step icon="check" stepName="Finish" onClick={this.swapFormActive(2)(4)}></Step>
            </Stepper>
              ...
              <Row>
                ...
                { this.state.formActivePanel2 === 3  &&
                  (<Col md="12">
                    ...
                    <Input label="I agreee to the terms and conditions" type="checkbox" id="checkbox" autoFocus={this.calculateAutofocus(2)}/>
            ...
            <Row className="pt-5 justify-content-center">
              <Col md="2" className="pl-5 pl-md-0 pb-5">
                <Stepper icon vertical>
                  <Step icon="folder-open-o" stepName="Basic Information" onClick={this.swapFormActive(3)(1)} vertical></Step>
                  <Step icon="pencil" stepName="Personal Data" onClick={this.swapFormActive(3)(2)} vertical></Step>
                  <Step icon="photo" stepName="Terms and Conditions" onClick={this.swapFormActive(3)(3)} vertical></Step>
                  <Step icon="check" stepName="Finish" onClick={this.swapFormActive(3)(4)} vertical></Step>
                </Stepper>
              </Col>
              ...
              <Col md="7">
                ...
                (<Col md="12">
                  <h3 className="font-weight-bold pl-0 my-4">
                    <strong>Basic Information</strong></h3>
                  <Input label="Email" className="mt-4" autoFocus={this.calculateAutofocus(3)}/>
                  <Input label="Username" className="mt-4"/>
                  <Input label="Password" className="mt-4"/>
                  <Input label="Repeat Password" className="mt-4"/>
                  <Button color="mdb-color" rounded className="float-right" onClick={this.handleNextPrevClick(3)(2)}>next</Button>
                </Col>)}
                { this.state.formActivePanel3 === 2  &&
                (<Col md="12">
                  <h3 className="font-weight-bold pl-0 my-4"><strong>Personal Data</strong></h3>
                  <Input label="First Name" className="mt-3" autoFocus={this.calculateAutofocus(3)}/>
                  <Input label="Second Name" className="mt-3"/>
                  <Input label="Surname" className="mt-3"/>
                  <Input  label="Address" type="textarea" rows="2"/>
                  <Button color="mdb-color" rounded className="float-left" onClick={this.handleNextPrevClick(3)(1)}>previous</Button>
                  <Button color="mdb-color" rounded className="float-right" onClick={this.handleNextPrevClick(3)(3)}>next</Button>
                </Col>)}
                { this.state.formActivePanel3 === 3  &&
                (<Col md="12">
                  <h3 className="font-weight-bold pl-0 my-4"><strong>Terms and conditions</strong></h3>
                  <Input label="I agreee to the terms and conditions" type="checkbox" id="checkbox3" autoFocus={this.calculateAutofocus(3)} />
                  <Input label="I want to receive newsletter" type="checkbox" id="checkbox4" />
                  <Button color="mdb-color" rounded className="float-left" onClick={this.handleNextPrevClick(3)(2)}>previous</Button>
                  <Button color="mdb-color" rounded className="float-right" onClick={this.handleNextPrevClick(3)(4)}>next</Button>
                </Col>)}
                { this.state.formActivePanel3 === 4  &&
                (<Col md="12">
                  <h3 className="font-weight-bold pl-0 my-4"><strong>Finish</strong></h3>
                  <h2 className="text-center font-weight-bold my-4">Registration completed!</h2>
                  <Button color="mdb-color" rounded className="float-left" onClick={this.handleNextPrevClick(3)(3)}>previous</Button>
                  <Button color="success" rounded className="float-right" onClick={this.handleSubmission}>submit</Button>
                </Col>)}
              </Col>
            </Row>
