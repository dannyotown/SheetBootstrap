  ...
  return (
    <Container>
      ...
      <Container>
        ...
        <Button social="fb">
          <Fa icon="facebook" className="pr-1" /> Facebook
        </Button>
        <Button social="tw">
          <Fa icon="twitter" className="pr-1" /> Twitter
        </Button>
        <Button social="gplus">
          <Fa icon="google-plus" className="pr-1" /> Google +
        </Button>
        <Button social="li">
          <Fa icon="linkedin" className="pr-1" /> Linkedin
        </Button>
        <Button social="ins">
          <Fa icon="instagram" className="pr-1" /> Instagram
        </Button>
        <Button social="pin">
          <Fa icon="pinterest" className="pr-1" /> Pinterest
        </Button>
        <Button social="yt">
          <Fa icon="youtube" className="pr-1" /> Youtube
        </Button>
        <Button social="vk">
          <Fa icon="vk" className="pr-1" /> Vkontakte
        </Button>
        <Button social="so">
          <Fa icon="stack-overflow" className="pr-1" /> Stack Overflow
        </Button>
        <Button social="slack">
          <Fa icon="slack" className="pr-1" /> Slack
        </Button>
        <Button social="git">
          <Fa icon="github" className="pr-1" /> Github
        </Button>
        <Button social="comm">
        ...
        <Button social="dribbble">
          <Fa icon="dribbble" className="pr-1" /> Dribbble
        </Button>
