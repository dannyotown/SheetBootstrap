  ...
  render() {
    return (
      <MDBContainer>
        ...
        <SectionContainer title="Basic MDB Navs with Tabs & Pills" noBorder>
          <MDBRow>
            <MDBCol md="6">
        ...
        <SectionContainer title="Justified Navs with Tabs & Pills" noBorder>
          <MDBRow>
            <MDBCol md="6">
              <SectionContainer className="pb-5">
        ...
        <SectionContainer title="Navs with Tabs & Pills with dropdown" noBorder>
          <MDBRow>
            <MDBCol md="6">
              <SectionContainer className="pb-5">
