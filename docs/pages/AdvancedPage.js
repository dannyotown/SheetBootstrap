          ...
          <Col md="8" className="mt-3 mx-auto">
            <Jumbotron>
              ...
              <ul className="list-unstyled example-components-list">
                ...
                <NavLink className="list-group-item list-group-item-action" to="/advanced/pro/collapse">
                  <h5 style={{margin: '0'}} className="justify-content-between d-flex align-items-center">Accordion<Fa icon="angle-right" /></h5>
                </NavLink>
                <NavLink className="list-group-item list-group-item-action" to="/advanced/pro/charts">
                  <h5 style={{margin: '0'}} className="justify-content-between d-flex align-items-center">Charts<Fa icon="angle-right" /></h5>
                </NavLink>
                <NavLink className="list-group-item list-group-item-action" to="/advanced/pro/datepicker">
                  <h5 style={{margin: '0'}} className="justify-content-between d-flex align-items-center">Date picker<Fa icon="angle-right" /></h5>
                </NavLink>
                <NavLink className="list-group-item list-group-item-action" to="/advanced/pro/lightbox">
                  <h5 style={{margin: '0'}} className="justify-content-between d-flex align-items-center">Lightbox<Fa icon="angle-right" /></h5>
                </NavLink>
                <NavLink className="list-group-item list-group-item-action" to="/advanced/pro/multicarousel">
                  <h5 style={{margin: '0'}} className="justify-content-between d-flex align-items-center">Multi-item Carousel<Fa icon="angle-right" /></h5>
                </NavLink>
                <NavLink className="list-group-item list-group-item-action" to="/advanced/pro/scrollbar">
                  <h5 style={{margin: '0'}} className="justify-content-between d-flex align-items-center">ScrollBar<Fa icon="angle-right" /></h5>
                </NavLink>
                <NavLink className="list-group-item list-group-item-action" to="/advanced/pro/sticky">
                  <h5 style={{margin: '0'}} className="justify-content-between d-flex align-items-center">Sticky Content<Fa icon="angle-right" /></h5>
                </NavLink>
