...
import { Card, CardBody, CardTitle, CardText, ListGroup, ListGroupItem, CardHeader, CardFooter, Button, Col, Row, Nav, NavItem, NavLink, CardGroup, Jumbotron } from 'mdbreact';
    ...
    <section className="m-5">
      ...
      <Card className="text-center">
        <CardHeader>
          <Nav header>
            <NavItem>
              <NavLink active to="#">Active</NavLink>
            </NavItem>
            <NavItem>
              <NavLink to="#">Link</NavLink>
            </NavItem>
            <NavItem>
              <NavLink disabled to="#">Disabled</NavLink>
            </NavItem>
          </Nav>
        </CardHeader>
        <CardBody>
